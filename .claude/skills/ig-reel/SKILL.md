...
1. Read `.agents/instagram/voice.md` if it exists. That is the user's voice
...
4. If `.agents/instagram/swipe.md` exists, read it. `/ig-viral` writes that
...
posts it. On "yes", append to `.agents/instagram/log.md` with the date, the
