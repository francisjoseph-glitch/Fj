...
For complex or long-form content, delegate to the content-generation agent (defined in `.claude/agents/content-generation.md`).
For high-stakes content, delegate to the quality-assurance agent (defined in `.claude/agents/quality-assurance.md`) for validation.
