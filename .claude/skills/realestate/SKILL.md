---
name: realestate
description: "AI real estate analyst orchestrator. Routes /realestate commands (analyze, rental, invest, comps, market, mortgage, compare, screen, listing, flip, commercial, quick, report-pdf) to the matching sub-skill and sets scoring and output standards. US-built: adapt currency, taxes, stamp duty, LMI and rental norms before relying on figures for Australian property."
---
